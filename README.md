...
- [Store State Not State Changes](docs/store-state-not-state-changes.md)
- [Store State Changes Not State](docs/store-state-changes-not-state.md)
- [Store Data In Object Store Systems](docs/store-data-in-object-store-systems.md)
...
- [Microkernel Software Architecture](docs/microkernel-software-architecture.md)
- [Event Driven Software Architecture](docs/event-driven-software-architecture.md)
- [Space-Based Software Architecture](docs/space-based-software-architecture.md)
- [Microservices Software Architecture](docs/microservices-software-architecture.md)
- [Cloud Native Software Architecture](docs/cloud-native-software-architecture.md)
...
- [Develop Software To Run Anywhere Using WebAssembly](docs/develop-software-to-run-anywhere-with-webassembly.md)