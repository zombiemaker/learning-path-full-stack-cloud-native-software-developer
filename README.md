...
- [Serialize Data In JSON Format](docs/serialize-data-in-json-format.md)
- [Serialize Data In JSON-LD Format](docs/serialize-data-in-json-ld-format.md)
- [Serialize Data In XML Format](docs/serialize-data-in-xml-format.md)
- [Serialize Data In EXI Format](docs/serialize-data-in-exi-format.md)
- [Serialize Data In Protocol Buffers Format](docs/serialize-data-in-protocol-buffers-format.md)
- [Serialize Data In Apache Avro Format](docs/serialize-data-in-apache-avro-format.md)
- [Serialize Data In ASN.1 Format](docs/serialize-data-in-asn1-format.md)
- [Serialize Data In YAML Format](docs/serialize-data-in-yaml-format.md)
...
- [Model Application Data With Relational Data Models](docs/model-application-data-with-relational-data-models.md)
- [Model Application Data With Key-Value Data Models](docs/model-application-data-with-key-value-data-models.md)
- [Model Application Data With Graph Data Models](docs/model-application-data-with-graph-data-models.md)
- [Model Application Data With Document Data Models](docs/model-application-data-with-document-data-models.md)
- [Model Application Data With Columnar Data Models](docs/model-application-data-with-columnar-data-models.md)
...
- [Develop Application System Using Microkernel Software Architecture](docs/develop-application-system-using-microkernel-software-architecture.md)
- [Develop Application System Using Event Driven Software Architecture](docs/develop-application-system-using-event-driven-software-architecture.md)
- [Develop Application System Using Space-Based Software Architecture](docs/develop-application-system-using-space-based-software-architecture.md)
- [Develop Application System Using Microservices Software Architecture](docs/develop-application-system-using-microservices-software-architecture.md)
- [Develop Application System Using Cloud Native Software Architecture](docs/develop-application-system-using-cloud-native-software-architecture.md)
