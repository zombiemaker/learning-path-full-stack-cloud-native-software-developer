...
- [Serialize Data In Apache Avro Format](serialize-data-in-apache-avro-format.md)
- [Serialize Data In ASN.1 Format](serialize-data-in-asn1-format.md)
- [Serialize Data In YAML Format](serialize-data-in-yaml-format.md)